...
%plot(Zon2_PL4.Data(:,3:4))

Vy=(Zon2_PL3.Data(:,3:4)-0);
Qu=Zon2_PL3.Data(:,1:2);
...
tt=Zon2_PL4.Time;
Vy=(Zon2_PL4.Data(:,3:4)-0);
Qu=Zon2_PL4.Data(:,1:2);
% subplot(2,1,1);plot(Qu);subplot(2,1,2);plot(Vy);
ts=tt; dys=Vy; dus=Qu;
its=1;eve=20000;
nyus=length(dys(1,:)); 
...
Qd2=diag(Qd2); Qd2(1:4)=0.0001;  Qd2([5 6])=20; Qd2=diag(Qd2);Qd2(7)=1;
Rd2=eye(1)*0.01;
